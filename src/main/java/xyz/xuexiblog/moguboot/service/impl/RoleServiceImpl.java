...
import xyz.xuexiblog.moguboot.dao.RoleDao;
...
public class RoleServiceImpl implements RoleService {
     ...
     */
    @Override
    public Role queryById(String uid) {
        return this.roleDao.queryById(uid);
    }
    ...
    public Role update(Role role) {
        ...
        return this.queryById(role.getUid());
    }
    ...
    public boolean deleteById(String uid) {
        return this.roleDao.deleteById(uid) > 0;
    }
}